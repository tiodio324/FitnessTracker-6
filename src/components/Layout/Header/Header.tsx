      ...
      <div className={styles.left}>
        ...
        >
          <svg className={styles.logoIcon} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            <path d="M6.5 6.5a3.5 3.5 0 117 0 3.5 3.5 0 01-7 0zM2.5 21.5a.5.5 0 01-.5-.5v-1a7 7 0 0114 0v1a.5.5 0 01-.5.5h-13z" />
            <path d="M17 9l2 2 4-4" />
          </svg>
          <span className={styles.logoText}>Фитнес-трекер</span>
        </div>
      </div>
